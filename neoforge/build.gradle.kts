...
dependencies {
    ...
    minecraftRuntimeLibraries("com.github.Treetrain1:Jankson:mod-SNAPSHOT")
    minecraftRuntimeLibraries("com.github.Treetrain1:xjs-data:infinity-compat-SNAPSHOT")
    minecraftRuntimeLibraries("org.exjson:xjs-compat:$xjs_compat_version")
    minecraftRuntimeLibraries("com.personthecat:fresult:$fresult_version")
