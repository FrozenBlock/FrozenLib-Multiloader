...
public class RegistryEvents {
	 ...
	 */
	public static final FrozenEvent<DynamicRegistrySetupCallback> DYNAMIC_REGISTRY_SETUP = FrozenEvent.createEvent(DynamicRegistrySetupCallback.class);
	 ...
	 * Use {@link RegistryAccess#registry} to prevent crashes.
	 */
	public static final FrozenEvent<DynamicRegistryLoadedCallback> DYNAMIC_REGISTRY_LOADED = FrozenEvent.createEvent(DynamicRegistryLoadedCallback.class);
	 ...
	 */
	@FunctionalInterface
	public interface EntryAdded<V> extends CommonEventEntrypoint {
		/**
