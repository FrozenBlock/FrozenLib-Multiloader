...
public class AdvancedMath {
	...
	/**
	 * @return a new {@link RandomSource} instance.
	 */
	@Contract(" -> new")
	@NotNull
	...
	public static Vec3 rotateAboutXZ(@NotNull Vec3 original, double distanceFrom, double angle) {
		double calcAngle = angle * Mth.RAD_TO_DEG;
	...
	/**
	 * Returns the angle of a point, assuming the origin is {@link Vec3#ZERO}.
	 *
	 * @param pos The {@link Vec3} to use.
	 * @return the angle of the point, assuming the origin is {@link Vec3#ZERO}.
	 */
	@Contract(pure = true)
	...
	/**
	 * Returns the angle between two points, assuming the origin is {@link Vec3#ZERO}.
	 *
	 * @param posA The first {@link Vec3} to compare.
	 * @param posB The second {@link Vec3} to compare.
