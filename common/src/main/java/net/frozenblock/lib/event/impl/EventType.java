...
import net.frozenblock.lib.event.entrypoint.ServerEventEntrypoint;
import org.jetbrains.annotations.ApiStatus;

/**
 * Enum class representing the entrypoints
 */
@ApiStatus.Internal
public enum EventType {
	...
	/**
	 * The entrypoint identifier for the event type.
	 */
	private final String entrypointIdentifier;

	/**
	 * The entrypoint class for the event type.
	 */
	 ...
	 *
	 * @param entrypointIdentifier The entrypoint identifier for the event type.
	 * @param entrypoint The entrypoint class for the event type.
	 */
	EventType(String entrypointIdentifier, Class<?> entrypoint) {
		this.entrypointIdentifier = entrypointIdentifier;
		this.entrypoint = entrypoint;
	}

	/**
	 * Returns the entrypoint identifier for the event type.
	 *
	 * @return The entrypoint identifier.
	 */
	public String entrypointIdentifier() {
		return this.entrypointIdentifier;
	}

	/**
	 * Returns the entrypoint class for the event type.
	 *
