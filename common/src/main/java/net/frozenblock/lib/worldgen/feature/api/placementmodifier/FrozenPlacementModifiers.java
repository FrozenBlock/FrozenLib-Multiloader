...
public class FrozenPlacementModifiers {
	public static final PlacementModifierType<LowerHeightmapPlacement> ACCURATE_HEIGHTMAP;
	public static final PlacementModifierType<NoisePlacementFilter> NOISE_FILTER;
	...
	static {
		ACCURATE_HEIGHTMAP = register("improved_heightmap", LowerHeightmapPlacement.CODEC);
		NOISE_FILTER = register("noise_filter", NoisePlacementFilter.CODEC);
	}
}
