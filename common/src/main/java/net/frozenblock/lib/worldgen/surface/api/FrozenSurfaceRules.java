...
public final class FrozenSurfaceRules {
	...
	public static SurfaceRules.RuleSource getOverworldSurfaceRules() {
		...
		SurfaceRuleEvents.MODIFY_OVERWORLD.invoke(it -> it.addOverworldSurfaceRules(sourceHolders));
		...
		SurfaceRuleEvents.MODIFY_OVERWORLD_NO_PRELIMINARY_SURFACE.invoke(it -> it.addOverworldNoPrelimSurfaceRules(noPrelimSourceHolders));
	...
	public static SurfaceRules.RuleSource getNetherSurfaceRules() {
		...
		SurfaceRuleEvents.MODIFY_NETHER.invoke(it -> it.addNetherSurfaceRules(sourceHolders));
	...
	public static SurfaceRules.RuleSource getEndSurfaceRules() {
		...
		SurfaceRuleEvents.MODIFY_END.invoke(it -> it.addEndSurfaceRules(sourceHolders));
	...
	public static SurfaceRules.RuleSource getGenericSurfaceRules(ResourceKey<DimensionType> dimension) {
		...
		SurfaceRuleEvents.MODIFY_GENERIC.invoke(it -> it.addGenericSurfaceRules(sourceHolders));
