...
import net.frozenblock.lib.entity.impl.behavior.FrozenLibBehaviorInterface;
...
public abstract class MoveToBlockBehavior<E extends PathfinderMob> extends Behavior<E> {
	...
	public boolean canStillUse(@NotNull ServerLevel level, @NotNull E entity, long gameTime) {
		return this.tryTicks >= -((FrozenLibBehaviorInterface) this).frozenLib$getDuration() && this.tryTicks <= DURATION && this.isValidTarget(level, this.blockPos);
	}
