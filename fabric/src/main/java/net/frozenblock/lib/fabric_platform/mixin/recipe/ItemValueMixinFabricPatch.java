...
package net.frozenblock.lib.fabric_platform.mixin.recipe;
...
public class ItemValueMixinFabricPatch {
	...
	private static Codec<Ingredient.ItemValue> frozenLib$fabric$newCodec(
		...
		Operation<Codec<Ingredient.ItemValue>> original
	) {
