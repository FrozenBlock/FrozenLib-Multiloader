...
package net.frozenblock.lib.fabric_platform.mixin.item.axe;
...
@Mixin(AxeItem.class)
public class AxeItemMixinFabricPatch {
	...
	public Optional<BlockState> frozenlib$fabric$runAxeBehavior(
		AxeItem instance,
		Level world,
		BlockPos pos,
		Player player,
